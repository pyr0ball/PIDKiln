...
- You have to already have installed ESP32 framework (PIDKiln <v1.2 requires ESP32 <2.0.x, PIDKiln v1.2+ requires ESP32 2.0.x) - if don't, do it now (https://github.com/iotechbugs/esp32-arduino/blob/master/docs/arduino-ide/boards_manager.md).
